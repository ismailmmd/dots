...
##### ISMAIL - CONFIGURATION #####

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion
export PATH=$HOME/.local/bin:$PATH # Devbox configuration
...
# this makes z work with our custom cd
alias ztemp='_z 2>&1'
unalias z
z() {
    ztemp $1 && cd .
...
#Colima - Docker socket symlinking
export DOCKER_HOST=unix:///Users/ismailmohammed/.colima/docker.sock
